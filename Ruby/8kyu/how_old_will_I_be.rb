...
this so they've begged you to help them out by writing a programme that can
answer Philip's endless questions.

Your task is to write a function that takes two parameters: the year of birth and
the year to count years in relation to. As Philip is getting more curious every
...
def calculate_age(year_of_birth, current_year)
  if current_year - year_of_birth == 1
      "You are 1 year old."
  elsif current_year - year_of_birth > 1
      "You are #{current_year - year_of_birth} years old."
  elsif current_year - year_of_birth == 0
      "You were born this very year!"
  elsif current_year - year_of_birth == -1
      "You will be born in #{year_of_birth  - current_year} year."
  else
